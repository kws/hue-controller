...
/* GET users listing. */
router.get('/flash/lights/:lights/:colour', async (req, res) => {
...
router.get('/info/schedules', async (req, res) => {
...
router.get('/info/groups', async (req, res) => {
...
router.get('/info/lights', async (req, res) => {
	const api = await controller.api();
...
router.get('/info/sensors', async (req, res) => {
	const api = await controller.api();
...
router.get('/info/time', async (req, res) => {
	res.send("" + new Date())
});

router.get('/info/tz', async (req, res) => {
